...
if (isset($_GET['id'])) {
    try {
        ...
        $stmt_select_genre_codes = 'SELECT genre_code FROM genres';

        // SQL文を実行する
        $stmt_select_genre_codes = $pdo->query($stmt_select_genre_codes);
                ...
                <div>
                    ...
                    <select id="genre_code" name="genre_code" required>
                        ...
                        foreach ($genre_codes as $genre_code) {
                            // もし変数$vendor_codeが書籍の仕入先コードの値と一致していれば、selected属性をつけて初期値にする
